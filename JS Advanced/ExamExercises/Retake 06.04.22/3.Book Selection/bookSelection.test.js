...
describe("Tests …", function() {
    ...
    describe('isGenreSuitable', () => {
        it("happy path", () => {
           ...
           expect(bookSelection.isGenreSuitable('any', 20)).to.equal(`Those books are suitable`);
           expect(bookSelection.isGenreSuitable('any', 10)).to.equal(`Those books are suitable`);
        });
